...
function StickyNoteCreateForm({ accounts }) {
  ...
  return (
    // <div class="absolute center-24 right-2 ml">
      ...
      <label htmlFor="Status">Status</label>
            ...
            >
              ...
              <textarea
                ...
                name="text"
                id="content"
                className="CONTENT-BOX flex-grow overflow-auto scrollbar-card scrollbar-w-3 text-dark_mode_font focus:outline-none bg-transparent border-solid border-[1px] border-text-dark_mode_text_white resize-none mx-[3.2rem] text-[1.5rem] p-5 h-[25vh]"
              ></textarea>
            ...
            <div className="MEMBER-LIST w-[20.5625rem] h-[39.375rem] bg-[#CCCCCC] bg-opacity-60 backdrop-blur-[9.3px] rounded-[19px] flex flex-col text-dark_mode_font ">
              ...
              <div className="mx-10 h-[75%] flex flex-col text-lg overflow-auto scrollbar-members-list"></div>
