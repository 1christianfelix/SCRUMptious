...
def create_sticky(sticky: CreateSticky,
                  stickyboard_id: str = Path(
                    ..., title="The ID of the sticky board"),
...
def get_stickies_data(stickyboard_id: str = Path(
                        ..., title="The ID of the sticky board"),
                      queries: StickyBoardQueries = Depends(),
                      account_data: dict = Depends(
                        authenticator.get_current_account_data)
...
def update_sticky(
    sticky_id: str, sticky: UpdateSticky, queries: StickyQueries = Depends(),
...
def delete_sticky(sticky_id: str,
